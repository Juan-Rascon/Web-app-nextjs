...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return getAllGammas; });
const db = __webpack_require__("kit0");

async function getAllGammas(req, res) {
  if (req.method === 'GET') {
    try {
...
module.exports = __webpack_require__("/SED");
...
fs.readdirSync(__dirname).filter(file => {
  ...
  const model = __webpack_require__("nVwW")(path.join(__dirname, file))(sequelize, Sequelize.DataTypes);
